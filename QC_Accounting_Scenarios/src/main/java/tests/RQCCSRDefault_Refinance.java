               ...
               for (int row = 2; row <= lastrow; row++) {
				...
				if (SSN.equals(RegSSN)) {
					...
					//=========================================================================		
							...
							String loanamount=driver.findElement(By.name("htmlLoanAmt")).getAttribute("value");
							test.log(LogStatus.PASS, "<FONT color=green style=Arial>Loan Amount : " +loanamount);
						
							String loanfee=driver.findElement(By.name("htmlLoanFee")).getAttribute("value");
							test.log(LogStatus.PASS, "<FONT color=green style=Arial>LoanFee Amount : " +loanfee);
							
							String totalamount=driver.findElement(By.name("htmlTotAmt")).getAttribute("value");
							test.log(LogStatus.PASS, "<FONT color=green style=Arial>total Amount : " +loanfee);
