...
//=======================================================
		...
		else
		{
			...
			//if(driver.findElement(By.xpath("/html/body/form/table/tbody/tr/td/table/tbody/tr[2]/td/table/tbody/tr/td/b[3]")).getText().contains("confirm_text1")){
			if(driver.findElement(By.xpath("/html/body/form/table/tbody/tr/td/table/tbody/tr[2]/td/table/tbody/tr/td")).getText().contains(" has been completed successfully")){
