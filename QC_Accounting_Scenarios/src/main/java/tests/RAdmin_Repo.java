...
public class RAdmin_Repo extends QCStore{
	public static String SSN1;
	public static String SSN2;
	public static String SSN3;


	public static void repo(WebDriver driver,String SSN,String AppURL)
	{
	try{
	...
	driver.findElement(By.name("requestBean.repoStatusId")).sendKeys(RepoRequest);
	test.log(LogStatus.PASS, "Repo Request Selected as :" +RepoRequest); 
	...
	for(int k=1;k<=5;k++){
		driver.findElement(By.id("button")).sendKeys(Keys.TAB);
	}
	//driver.findElement(By.id("button")).sendKeys(Keys.ENTER);
	driver.findElement(By.xpath("//input[@value='Send' and @type='button']")).sendKeys(Keys.ENTER);
	test.log(LogStatus.PASS, "Clicked on Send Button");
	Thread.sleep(1000);
	driver.findElement(By.name("Ok")).click();
	test.log(LogStatus.PASS, "Transaction Completed Successfully");
	Thread.sleep(1000);
	test.log(LogStatus.PASS, "<FONT color=green style=Arial> New Repo Request Send Successfully ");
