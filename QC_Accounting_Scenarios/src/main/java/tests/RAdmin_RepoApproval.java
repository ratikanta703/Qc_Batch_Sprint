...
public class RAdmin_RepoApproval extends QCStore{
	...
	public static void repoapproval(WebDriver driver,String SSN,String AppURL) throws Exception
	{
	try{
	...
	//driver.findElement(By.xpath("//*[@id='9881908089']/a")).click();
	...
	try {
		...
		test.log(LogStatus.INFO, "View Contact Check Box Closed not available");
	}	
	//driver.findElement(By.xpath("//input[@value='Close' and @type='button']")).click();
	//test.log(LogStatus.PASS, "Clicked on View Contact Check Box Closed");
	Thread.sleep(1200);	
