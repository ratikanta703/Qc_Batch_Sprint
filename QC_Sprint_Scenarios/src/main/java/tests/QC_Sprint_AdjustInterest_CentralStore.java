...
public class QC_Sprint_AdjustInterest_CentralStore extends QCStore {
		...
		try {
			...
			for (int row = 2; row <= lastrow; row++) {
				...
				if (SSN.equals(RegSSN)) {
					...
					Thread.sleep(3000);
					test.log(LogStatus.INFO, "*********************  Login in to Central Store  **************");
	...
	public static void Centralstore_adjustinterest_Void_Disable_verification(String SSN, String AppURL) throws Exception {
		try {
			int lastrow = TestData.getLastRow("adjust_interest");
			String sheetName = "adjust_interest";
			...
			for (int row = 2; row <= lastrow; row++) {
				...
				if (SSN.equals(RegSSN)) {
					...
					test.log(LogStatus.PASS, "Clicked on Collection Mgmt Link");
					Thread.sleep(1000);
					//===========================================================================================
					driver.switchTo().frame("main");
					driver.findElement(By.name("requestBean.installmentType")).sendKeys(ProductType);
						...
						if (driver.findElement(By.xpath("/html/body/form[1]/table[2]/tbody/tr[2]/td[3]/font")).isDisplayed()){
							...
							Thread.sleep(5000);
								...
								if (driver.findElement(By.xpath("//*[@id='voidadjustInterest']")).isEnabled()){
									test.log(LogStatus.FAIL, "Adjust Interest Void Button Is Available");
								
								break;
							}
							else {
								
								test.log(LogStatus.PASS, "<FONT color=green style=Arial> Adjust Interest Void Button Is Not Available ");
							}
	...
	public static void Centralstore_adjustinterest_Void_verification(String SSN, String AppURL) throws Exception {
		try {
			int lastrow = TestData.getLastRow("adjust_interest");
			String sheetName = "adjust_interest";
	...
	public static void CentralStore_Void_verification(String SSN, String AppURL) throws Exception {
		try {
			int lastrow = TestData.getLastRow("adjust_interest");
			String sheetName = "adjust_interest";
	...
	public static void CentralStore_Void_Enable_verification(String SSN, String AppURL) throws Exception {
		try {
			int lastrow = TestData.getLastRow("adjust_interest");
			String sheetName = "adjust_interest";
			...
			//String loan_number="11318094";
					...
					if (driver.findElement(By.xpath("//*[@id='voidadjustInterest']")).isEnabled()){
						...
						test.log(LogStatus.FAIL, "Adjust Interest Void Button Is  Disabled");
	...
	public static void central_store_adjustinterest_amount_increased(String SSN, String AppURL) throws Exception {
		try {
			int lastrow = TestData.getLastRow("adjust_interest");
			String sheetName = "adjust_interest";
			...
			for (int row = 2; row <= lastrow; row++) {
				...
				if (SSN.equals(RegSSN)) {
					...
					Thread.sleep(3000);
					test.log(LogStatus.INFO, "******* Central Store Adjust Interest and Void Button Verification started ********");
					driver.switchTo().frame("topFrame");	        
					wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("li[id='940000']")));			       
					driver.findElement(locator(prop.getProperty("account_mgmt_tab"))).click();	
					Thread.sleep(2000);				
