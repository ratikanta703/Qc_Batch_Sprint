	...
	public static void twopdlloanstatus(String SSN, String AppURL) {
		try {
         ...
         //========================= Loan Status Verification Started==============
						...
						String ClosedLoanStatus = driver.findElement(By.xpath("/html/body/form[1]/table/tbody/tr/td/table/tbody/tr/td/table[2]/tbody/tr[8]/td[2]/table/tbody/tr/td/table/tbody/tr[9]/td[5]")).getText();
						String NewLoanStatus = driver.findElement(By.xpath("/html/body/form[1]/table/tbody/tr/td/table/tbody/tr/td/table[2]/tbody/tr[8]/td[2]/table/tbody/tr/td/table/tbody/tr[11]/td[5]")).getText();
