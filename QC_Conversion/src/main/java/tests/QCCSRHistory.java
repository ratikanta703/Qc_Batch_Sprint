...
public class QCCSRHistory extends QCStore{
	...
	public static void pdltoilphistory(String SSN,String AppURL) throws ParseException, InterruptedException
	{
			...
			String sheetName_Conversion="Conversion";
			...
			{	
				...
				if(SSN.equals(RegSSN))
				{
			       ...
			       String ESign_CollateralType = TestData.getCellData(sheetName_Conversion,"ESign_CollateralType",row);
			       String LoanStatus = TestData.getCellData(sheetName_Conversion,"LoanStatus",row);
			       String courtesy_consent=TestData.getCellData(sheetName_Conversion,"ESign_CourtesyCallConsent",row);
			     //  String courtesy_consent_status=TestData.getCellData(sheetName_ILP_Conversion,"ESign_Preference",row);
			       String collateral_type=TestData.getCellData(sheetName_Conversion,"ESign_CollateralType",row);
	 ...
	 //ACH collateral details from sheet
				...
				//	test.log(LogStatus.INFO, MarkupHelper.createLabel("Transaction History validation has started", ExtentColor.BLUE));
				  ...
				  // test.log(LogStatus.PASS, "Loan Number is" + loan_nbr);
					...
					test.log(LogStatus.PASS, "Clicked on ILP Loan GO Button under search results");
			 ...
			 //Validations
						...
						String courtesy_inf_courtesy_consent= driver.findElement(locator(prop.getProperty("courtesy_inf_courtesy_consent"))).getText();
						...
						String loan_balance_inf_principal_bal=driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[3]/table/tbody/tr[17]/td/span[2]")).getText();
						
						String loan_balance_inf_fee_due=driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[3]/table/tbody/tr[19]/td/span[2]")).getText(); 
								//driver.findElement(locator(prop.getProperty("loan_balance_inf_fee_due"))).getText();
						...
						String loan_account_inf_inst_amt= driver.findElement(locator(prop.getProperty("loan_account_inf_loan_date"))).getText();
						String loan_account_inf_no_of_installments= driver.findElement(locator(prop.getProperty("loan_account_inf_max_term_date"))).getText();
						String loan_account_inf_collateral_type= driver.findElement(locator(prop.getProperty("loan_account_inf_collateral_type"))).getText();
						String loan_account_inf_loan_frequency= driver.findElement(locator(prop.getProperty("loan_account_inf_loan_frequency"))).getText();
						...
						String cust_promotion_campaign_name= driver.findElement(locator(prop.getProperty("cust_promotion_campaign_name"))).getText();
						
						                                                              
						
						//String cust_promotion_coupon_code= driver.findElement(locator(prop.getProperty("cust_promotion_coupon_code"))).getText();
...
//Loan paid to date summary
						String loan_paid_summary_principal_paid_date= driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[3]/table/tbody/tr[27]/td/span/span")).getText();
						String loan_paid_summary_fee_paid_date= driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[3]/table/tbody/tr[28]/td/span/span")).getText();
						String loan_paid_summary_return_paid_date= driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[3]/table/tbody/tr[29]/td/span[2]")).getText();
						String loan_paid_summary_late_paid_date= driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[3]/table/tbody/tr[30]/td/span[2]")).getText();
						String loan_balance_inf_past_due_amt= driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[3]/table/tbody/tr[22]/td/span[2]")).getText();
	...
	public static void ilp_pdl_history(String SSN,String AppURL) throws ParseException, InterruptedException
	{
...
//Loan paid to date summary
	...
	public static void toilphistory(String SSN,String AppURL) throws ParseException, InterruptedException
	{
	 ...
	 //ACH collateral details from sheet
				...
				//	test.log(LogStatus.INFO, MarkupHelper.createLabel("Transaction History validation has started", ExtentColor.BLUE));
				  ...
				  // test.log(LogStatus.PASS, "Loan Number is" + loan_nbr);
					...
					Thread.sleep(500);
					driver.findElement(By.xpath("/html/body/form[1]/table/tbody/tr/td/table/tbody/tr/td/table[2]/tbody/tr[8]/td[2]/table/tbody/tr/td/table/tbody/tr[9]/td[13]/input[1]")).click();
			 ...
			 //Validations
						...
						//String loan_balance_inf_return_fee_due= driver.findElement(locator(prop.getProperty("loan_balance_inf_return_fee_due"))).getText();
						String loan_balance_inf_return_fee_due= driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[3]/table/tbody/tr[19]/td/span[2]")).getText();
						String loan_balance_inf_late_fee_due= driver.findElement(locator(prop.getProperty("loan_balance_inf_late_fee_due"))).getText();
						String loan_balance_inf_pay_off_amt= driver.findElement(locator(prop.getProperty("loan_balance_inf_pay_off_amt"))).getText();
						String loan_account_inf_product_name= driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[4]/table/tbody/tr[2]/td/span")).getText();
						String loan_account_inf_product_type= driver.findElement(locator(prop.getProperty("loan_account_inf_product_type"))).getText();
						String loan_account_inf_loan_nbr= driver.findElement(locator(prop.getProperty("loan_account_inf_loan_nbr"))).getText();
						String loan_account_inf_loan_amt= driver.findElement(locator(prop.getProperty("loan_account_inf_loan_amt"))).getText();
						//String loan_account_inf_APR= driver.findElement(locator(prop.getProperty("loan_account_inf_APR"))).getText();
						String loan_account_inf_APR= driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[4]/table/tbody/tr[6]/td/span[2]")).getText();
						String loan_account_inf_interest_rate= driver.findElement(locator(prop.getProperty("loan_account_inf_interest_rate"))).getText();
						String loan_account_inf_inst_amt= driver.findElement(locator(prop.getProperty("loan_account_inf_loan_date"))).getText();
						String loan_account_inf_no_of_installments= driver.findElement(locator(prop.getProperty("loan_account_inf_max_term_date"))).getText();
						...
						String loan_account_inf_loan_frequency= driver.findElement(locator(prop.getProperty("loan_account_inf_loan_frequency"))).getText();
						String loan_account_inf_original_store= driver.findElement(locator(prop.getProperty("loan_account_inf_original_store"))).getText();
						//String loan_account_inf_available_credit= driver.findElement(locator(prop.getProperty("loan_account_inf_available_credit"))).getText();
						String loan_account_inf_available_credit= driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[4]/table/tbody/tr[16]/td/span[2]")).getText();
						...
						//String cust_promotion_coupon_code= driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[1]/table/tbody/tr[25]/td")).getText();
						//cust_promotion_coupon_code= driver.findElement(locator(prop.getProperty("cust_promotion_coupon_code"))).getText();
//Loan paid to date summary
						String loan_paid_summary_principal_paid_date= driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[3]/table/tbody/tr[27]/td/span/span")).getText();
						String loan_paid_summary_fee_paid_date= driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[3]/table/tbody/tr[28]/td/span/span")).getText();
	...
	public static void twopdlloantoilphistory(String SSN,String AppURL) throws ParseException, InterruptedException
	{
	 ...
	 //ACH collateral details from sheet
				...
				//	test.log(LogStatus.INFO, MarkupHelper.createLabel("Transaction History validation has started", ExtentColor.BLUE));
				  ...
				  // test.log(LogStatus.PASS, "Loan Number is" + loan_nbr);
					...
					test.log(LogStatus.PASS, "Clicked on Show More Link");
					Thread.sleep(500);
					driver.findElement(By.xpath("/html/body/form[1]/table/tbody/tr/td/table/tbody/tr/td/table[2]/tbody/tr[8]/td[2]/table/tbody/tr/td/table/tbody/tr[11]/td[13]/input")).click();
			 ...
			 //Validations
						...
						//String cust_promotion_coupon_code= driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[1]/table/tbody/tr[25]/td")).getText();
								//driver.findElement(locator(prop.getProperty("cust_promotion_coupon_code"))).getText();
						//cust_promotion_coupon_code=driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[1]/table/tbody/tr[25]/td")).getText(); 
								
//Loan paid to date summary
						String loan_paid_summary_principal_paid_date= driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[3]/table/tbody/tr[27]/td/span/span")).getText();
								//driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[3]/table/tbody/tr[26]/td/span/span")).getText();
						String loan_paid_summary_fee_paid_date= driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[3]/table/tbody/tr[28]/td/span/span")).getText();
								//driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[3]/table/tbody/tr[27]/td/span/span")).getText();
						String loan_paid_summary_return_paid_date= driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[3]/table/tbody/tr[29]/td/span[2]")).getText();
								//driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[3]/table/tbody/tr[28]/td/span[2]")).getText();
						String loan_paid_summary_late_paid_date=driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[3]/table/tbody/tr[30]/td/span[2]")).getText(); 
								//driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[3]/table/tbody/tr[29]/td/span[2]")).getText();
						String loan_balance_inf_past_due_amt= driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[3]/table/tbody/tr[22]/td/span[2]")).getText();
								//driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[3]/table/tbody/tr[21]/td/span[2]")).getText();
	...
	public static void ilptotlphistoryconversion(String SSN,String AppURL) throws ParseException, InterruptedException
	{
	 ...
	 //ACH collateral details from sheet
			 ...
			 //Validations
						...
						//cust_promotion_coupon_code= driver.findElement(locator(prop.getProperty("cust_promotion_coupon_code"))).getText();
//Loan paid to date summary
						String loan_paid_summary_principal_paid_date= driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[3]/table/tbody/tr[27]/td/span[2]")).getText();
						String loan_paid_summary_fee_paid_date= driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[3]/table/tbody/tr[28]/td/span[2]")).getText();
						String loan_paid_summary_return_paid_date= driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[3]/table/tbody/tr[29]/td/span[2]")).getText();
						String loan_paid_summary_late_paid_date= driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[3]/table/tbody/tr[30]/td/span[2]")).getText();
						String loan_balance_inf_past_due_amt= driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[3]/table/tbody/tr[22]/td/span[2]")).getText();
						...
						int n=rows.size();
							...
							n=n-1;
							//*[@id="transactionDetailsTable"]/tbody/tr[3]/td[5]/font
							String cust_transaction_date=driver.findElement(By.xpath("//*[@id='transactionDetailsTable']/tbody/tr["+n+"]/td[4]/font")).getText();
						...
						cust_transaction_date=cust_transaction_date_array[0];*/
							...
							String cust_doc_total_amount= driver.findElement(By.xpath("//*[@id='transactionDetailsTable']/tbody/tr["+n+"]/td[6]/font")).getText();
							String cust_doc_tender_type= driver.findElement(By.xpath("//*[@id='transactionDetailsTable']/tbody/tr["+n+"]/td[7]/font")).getText();
					
							String cust_doc_inst= driver.findElement(By.xpath("//*[@id='transactionDetailsTable']/tbody/tr["+n+"]/td[9]")).getText();
							String cust_doc_adv_amount= driver.findElement(By.xpath("//*[@id='transactionDetailsTable']/tbody/tr["+n+"]/td[10]/font")).getText();
							String cust_doc_interest= driver.findElement(By.xpath("//*[@id='transactionDetailsTable']/tbody/tr["+n+"]/td[11]/font")).getText();
						String cust_doc_new_balance= driver.findElement(By.xpath("//*[@id='transactionDetailsTable']/tbody/tr["+n+"]/td[16]/font")).getText();
						String cust_doc_PromotionCoupon_Amt=  driver.findElement(By.xpath("//*[@id='transactionDetailsTable']/tbody/tr["+n+"]/td[17]/font")).getText();
						String loan_paid_summary_total_paid_amt= driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[3]/table/tbody/tr[29]/td/span[2]")).getText();						
						...
						//To read from application       
						       ach_history_ach_type= driver.findElement(By.xpath("//*[@id='achHistoryTable']/tbody/tr[2]/td[3]")).getText();
								ach_history_ach_transaction= driver.findElement(By.xpath("//*[@id='achHistoryTable']/tbody/tr[2]/td[4]")).getText();
								ach_history_ach_status= driver.findElement(By.xpath("//*[@id='achHistoryTable']/tbody/tr[2]/td[5]")).getText();
								ach_history_ach_amt= driver.findElement(By.xpath("//*[@id='achHistoryTable']/tbody/tr[2]/td[6]")).getText();
								ach_history_ach_ABA_code= driver.findElement(By.xpath("//*[@id='achHistoryTable']/tbody/tr[2]/td[7]")).getText();
								ach_history_ach_check_acc_no= driver.findElement(By.xpath("//*[@id='achHistoryTable']/tbody/tr[2]/td[8]")).getText();			      }
					...
					if(total_paid_amountc.equalsIgnoreCase(loan_paid_summary_total_paid_amt))
							...
							if(campaign_name.trim().equalsIgnoreCase(cust_promotion_campaign_name.trim()))
							{
								test.log(LogStatus.PASS, "campaign_name->Expected value:"+campaign_name+"; == Actual value:"+cust_promotion_campaign_name);
							}
							else
							...
							/*if(promotion_code.trim().equalsIgnoreCase(cust_promotion_coupon_code.trim()))
							{
								test.log(LogStatus.PASS, "promotion_code->Expected value:"+promotion_code +"; == Actual value:"+cust_promotion_coupon_code);
							}
							else
	...
	public static void ilp_pdl_tlphistoryconversion(String SSN,String AppURL) throws ParseException, InterruptedException
	{
	 ...
	 //ACH collateral details from sheet
				...
				for(String winHandle : driver.getWindowHandles()){
					 ...
					 driver.switchTo().defaultContent();
					   ...
					   // driver.findElement(By.xpath(" /html/body/form[1]/table/tbody/tr/td/table/tbody/tr/td/table[2]/tbody/tr[7]/td[2]/table/tbody/tr/td/table/tbody/tr[4]/td[11]/input[1]")).click();
					    //driver.findElement(By.xpath("//input[@value='Go' and @type='button']")).click();
					    driver.findElement(By.xpath("/html/body/form[1]/table/tbody/tr/td/table/tbody/tr/td/table[2]/tbody/tr[7]/td[2]/table/tbody/tr/td/table/tbody/tr[11]/td[13]/input")).click();
					    test.log(LogStatus.PASS, "Clicked on TLP Loan Go button under Loans section");
