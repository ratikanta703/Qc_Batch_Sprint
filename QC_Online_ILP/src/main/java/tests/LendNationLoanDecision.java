...
public class LendNationLoanDecision extends QCStore{
	  ...
	  
	  {
			...
			Thread.sleep(1000);
              ...
              if(driver.findElement(By.xpath("//*[@id='msg']")).getText().contains("CODE MATCHED")){
			  ...
			  test.log(LogStatus.PASS, "Clicked on You Can Email to us CheckBox " );
			  ...
			  test.log(LogStatus.INFO, "******************************************************** ");
			  test.log(LogStatus.INFO, "****************** Redirecting To Disclosure Page *************************** ");
			  Thread.sleep(1000);
			  
			  driver.findElement(By.xpath("//*[@id='loanRateChartChk']")).click();
			  test.log(LogStatus.PASS, "Clicked on Rate Chart Checkbox in Disclosure Page " );
			  Thread.sleep(500);
			  driver.findElement(By.xpath("//*[@id='abilityToRepayChk']")).click();
			  test.log(LogStatus.PASS, "Clicked on Ability To Repay Checkbox in Disclosure Page " );
			  Thread.sleep(500);
			  driver.findElement(By.xpath("//*[@id='discContinue']")).click();
			  test.log(LogStatus.PASS, "Clicked on Submit Application button in Disclosure Page " );
			  Thread.sleep(30000);
			  test.log(LogStatus.INFO, "******************************************************** ");
			  test.log(LogStatus.INFO, "****************** Redirecting To SignContract Page *************************** ");
	  ...
	  public static void okilp_loandecision(String SSN,String AppURL) throws Exception
	  
	  {
			...
			//##########################################################
			  ...
			  if( driver.findElement(By.xpath("//*[@id='subHeading']/div/h1")).isDisplayed())
			  {
			
			  test.log(LogStatus.PASS, "<FONT color=green style=Arial>Loan Approved ");
			  }
			  else
				{
				test.log(LogStatus.FAIL, " Loan is not Approved");
				}
	 ...
	 //######################################################
			  ...
			  test.log(LogStatus.INFO, "************** Now Going To PAM For Esign Approval ******************** ");
...
public static void wiilp_loandecision_two(String SSN,String AppURL) throws Exception
...
public static void moilp_loandecision_storeoffer_unavailable_validation(String SSN,String AppURL) throws Exception

{
		...
		Thread.sleep(1000);
		  ...
		  try { 
			  if(driver.findElement(By.xpath("//*[@id='reqAprvdStoreAmt']/div/div[1]/h4")).isDisplayed())
				{
					Thread.sleep(500);
					
				  test.log(LogStatus.FAIL, "InStore Offer is displayed" );
				  Assert.assertTrue(false);
				}											

			}
			catch(Exception e){
				test.log(LogStatus.INFO, "<FONT color=green style=Arial> As per the Scenario: In Store Option is not displayed if the Zip Code is more then X miles");
			}
		  ...
		  Thread.sleep(30000);*/
		  test.log(LogStatus.INFO, "******************************************************** ");
		  test.log(LogStatus.INFO, "****************** Store Offer Validation Completed *************************** ");
...
public static void moilp_loandecision_storeoffer_available_validation(String SSN,String AppURL) throws Exception
		...
		Thread.sleep(1000);
		  ...
		  Thread.sleep(500);
			  ...
			  if(driver.findElement(By.xpath("//*[@id='reqAprvdStoreAmt']/div/div[1]/h4")).isDisplayed())
				{
					Thread.sleep(500);
					test.log(LogStatus.INFO, "<FONT color=green style=Arial> As per the Scenario: In Store Option is displayed if the Zip Code is Less then X miles");
				  
				}	
			  else{
				  test.log(LogStatus.FAIL, "InStore Offer is not displayed" );
				  Assert.assertTrue(false);
			  }
